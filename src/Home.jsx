    ...
    <div style={{ fontFamily:"'Inter',system-ui,sans-serif", minHeight:"100vh", background:"#f8fafc" }}>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .home-nav{position:sticky;top:0;z-index:100;background:rgba(2,20,44,.97);
          backdrop-filter:blur(12px);display:flex;align-items:center;
          justify-content:space-between;padding:0 6%;height:64px;
          border-bottom:1px solid rgba(255,255,255,.07);}
        .nav-brand{display:flex;align-items:center;gap:10px;text-decoration:none;}
        .nav-logo{width:36px;height:36px;background:linear-gradient(135deg,#3b82f6,#6366f1);
          border-radius:9px;display:flex;align-items:center;justify-content:center;
          color:#fff;font-weight:800;font-size:11px;flex-shrink:0;letter-spacing:-.3px;}
        .nav-logo-text{display:flex;flex-direction:column;}
        .nav-title{color:#f1f5f9;font-weight:700;font-size:1.05rem;line-height:1.2;}
        .nav-sub{font-size:.9rem;color:#94a3b8;font-weight:500;white-space:nowrap;}
        ...
        .btn-ghost{background:transparent;border:1px solid rgba(255,255,255,.2);
          ...
          font-size:.875rem;font-weight:500;transition:all .15s;font-family:inherit;}
        .btn-ghost:hover{background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.35);}
        .btn-primary-nav{background:linear-gradient(135deg,#1d4ed8,#4f46e5);border:none;
          color:#fff;padding:8px 22px;border-radius:8px;cursor:pointer;
        ...
        /* Hero */
        .hero{background:linear-gradient(135deg,#02142c 0%,#0f2544 50%,#1a1a3e 100%);
        ...
        .hero-badge{display:inline-flex;align-items:center;gap:6px;
          ...
          color:#93c5fd;padding:7px 20px;border-radius:20px;
        ...
        .hero-dept{font-size:.8rem;color:#475569;margin-bottom:16px;font-weight:500;letter-spacing:.02em;}
        .hero p{font-size:clamp(.95rem,2vw,1.05rem);color:#94a3b8;max-width:540px;
          margin:0 auto 32px;line-height:1.7;}
        .hero-btns{display:flex;gap:12px;justify-content:center;flex-wrap:wrap;}
        .btn-hero-main{background:linear-gradient(135deg,#1d4ed8,#4f46e5);border:none;
          color:#fff;padding:13px 30px;border-radius:10px;cursor:pointer;
        ...
        .btn-hero-sec{background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.2);
          color:#e2e8f0;padding:13px 30px;border-radius:10px;cursor:pointer;
          font-size:.98rem;font-weight:600;font-family:inherit;transition:all .2s;}
        ...
        .stat-item{padding:26px 44px;text-align:center;border-right:1px solid #e2e8f0;}
        .stat-item:last-child{border-right:none;}
        .stat-value{font-size:1.5rem;font-weight:800;color:#0f172a;line-height:1;}
        .stat-label{font-size:.76rem;color:#64748b;margin-top:4px;font-weight:500;}

        /* Features */
        .section{padding:72px 6%;}
        .section-label{font-size:.76rem;font-weight:700;color:#1d4ed8;
        ...
        .section-sub{font-size:.92rem;color:#64748b;text-align:center;
          max-width:480px;margin:0 auto 44px;line-height:1.65;}
        .features-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));
        ...
        .feature-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.08);
          border-color:#bfdbfe;}
        .feature-icon{width:44px;height:44px;background:#eff6ff;border-radius:10px;
          display:flex;align-items:center;justify-content:center;
          font-size:1.25rem;margin-bottom:12px;}
        .feature-title{font-size:.92rem;font-weight:700;color:#0f172a;margin-bottom:5px;}
        .feature-desc{font-size:.82rem;color:#64748b;line-height:1.6;}
        ...
        .cta-section h2{font-size:clamp(1.4rem,3vw,2rem);font-weight:800;
          color:#f1f5f9;margin-bottom:10px;letter-spacing:-.02em;}
        .cta-section p{color:#94a3b8;font-size:.92rem;margin-bottom:28px;}
        .cta-btns{display:flex;gap:12px;justify-content:center;flex-wrap:wrap;}
        .btn-cta-main{background:linear-gradient(135deg,#1d4ed8,#4f46e5);border:none;
          color:#fff;padding:12px 30px;border-radius:10px;cursor:pointer;
        ...
        .btn-cta-sec{background:rgba(255,255,255,.08);border:1px solid rgba(255,255,255,.2);
          color:#e2e8f0;padding:12px 30px;border-radius:10px;cursor:pointer;
          font-size:.92rem;font-weight:600;font-family:inherit;transition:all .2s;}
        ...
        .coord-label{font-size:.82rem;font-weight:700;text-transform:uppercase;
          letter-spacing:.1em;color:#c7d2e0;margin-bottom:6px;}
        .coord-name{font-size:1.3rem;font-weight:700;color:#ffffff;line-height:1.3;}
        .coord-role{font-size:.9rem;color:#d1d5db;margin-top:6px;}
        .coord-email{font-size:.9rem;color:#d1d5db;margin-top:4px;}
        .coord-sep{width:1px;height:36px;background:#ffffff;}

        /* Footer */
        .footer{background:#02142c;border-top:1px solid #0d2540;
          padding:24px 6%;display:flex;justify-content:space-between;
          align-items:center;flex-wrap:wrap;gap:10px;}
        .footer-brand{color:#94a3b8;font-size:.82rem;}
        .footer-brand strong{color:#60a5fa;}
        .footer-links{display:flex;gap:20px;}
        .footer-link{color:#64748b;font-size:.8rem;cursor:pointer;
        ...
        @media(max-width:640px){
          ...
          .coordinator{gap:16px;}
          .coord-sep{display:none;}
          .footer{padding:20px 5%;flex-direction:column;text-align:center;}
        }
      `}</style>
      ...
      <nav className="home-nav">
        <a className="nav-brand" href="/">
          <div className="nav-logo">CCE</div>
          <div className="nav-logo-text">
            <span className="nav-title">CCE</span>
            <span className="nav-sub">Centre for Competitive Examinations</span>
          </div>
        </a>
      ...
      <section className="hero">
        <div className="hero-badge">🎓 M. Kumarasamy College of Engineering</div>
        <h1>Centre for Competitive Examinations</h1>
...
<br />
      ...
      <section className="cta-section">
        ...
        <p>Join with us and achieve your Goal.</p>
      ...
      {/* Coordinator — above footer */}
      <div className="coordinator">
        <div>
          <div className="coord-label">Coordinator</div>
          <div className="coord-name">Dr. R. Balamurugan</div>
          <div className="coord-role">Associate Professor, Dept. of ECE</div>
        </div>
        <div className="coord-sep" />
        <div>
          <div className="coord-email">balamuruganr.ece@mkce.ac.in</div>
          <div className="coord-role">M. Kumarasamy College of Engineering</div>
        </div>
      </div>
      ...
      <footer className="footer">
        <div className="footer-brand">
          © 2025 <strong>CCE · Centre for Competitive Examinations</strong> · M. Kumarasamy College of Engineering
        </div>
